...
[Authorize(MyProjectPermissions.Authors.Default)]
public class AuthorAppService : ApplicationService, IAuthorAppService
{
    ...
    [Authorize(MyProjectPermissions.Authors.Create)]
    ...
    [Authorize(MyProjectPermissions.Authors.Edit)]
    ...
    [Authorize(MyProjectPermissions.Authors.Delete)]
